...
if process:
    ...
    def format_docs(docs):
        ...
        Returns:
            str: A string containing the page_content of each document, separated by newline.
        """
        # Generate the formatted string by joining the page_content of each document with a newline
